    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
        ...
        <div class="row no-gutters">
	            ...
	            <div class="media-body pr-lg-4">
	              ...
	              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean sed laoreet lectus, et feugiat.</p>
	            </div>
	          </div>
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce gravida mauris vitae dui efficitur gravida. Ut id rhoncus mi. Morbi scelerisque, velit ac laoreet dignissim, est magna faucibus ante, sed aliquam justo nulla sit amet.</p>
          ...
          <div class="col-md-12 text-center heading-section heading-section-light ftco-animate">
    		...
    		<div class="row d-flex sermon-wrap">
  				<div class="col-md-6 d-flex align-items-stretch ftco-animate">
  					<div class="img" style="background-image: url(static/images/sermon-1.jpg);"></div>
  				</div>
  				<div class="col-md-6 py-4 text ftco-animate">
  					<h2 class="mb-4"><a href="sermon.html">Lord is Sufficient for all of our needs</a></h2>
  					<div class="meta">
  						<p>
	  						<span>Sermon from: <a href="#" class="ptr">Elder D Musindira</a></span>
    ...
    <section class="ftco-section testimony-section img" style="background-image: url(static/images/bg_3.jpg);">
    	<div class="overlay"></div>
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec bibendum magna ex, in malesuada mi varius ac. Fusce ac sem.</p>
                    <p class="name">Elder Musundira</p>
