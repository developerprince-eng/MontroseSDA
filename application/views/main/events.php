          ...
          <div class="col-lg-12 ftco-animate">
          	<div class="event-wrap d-md-flex ftco-animate">
	          	...
	          	<div class="text pl-md-5">
	          		<h2 class="mb-3"><a href="sermons">Know Jesus Christ Better Through Lines</a></h2>
	          		<div class="meta">
		  						<p>
		  					...
		  					<p><a href="sermons" class="btn btn-primary">Read more</a></p>
	          	</div>
	          </div>
	          <div class="event-wrap d-md-flex ftco-animate">
	          ...
	          <div class="event-wrap d-md-flex ftco-animate">
	          	<div class="img"style="background-image: url(static/images/health.jpg);"></div>
	          	<div class="text pl-md-5">
	          		<h2 class="mb-3"><a href="sermons">Know Jesus Christ Better Through Lines</a></h2>
	          		<div class="meta">
		  						<p>
	          ...
	          <div class="event-wrap d-md-flex ftco-animate">
	          	<div class="img"style="background-image: url(static/images/100_years.jpg);"></div>
	          	<div class="text pl-md-5">
	          		<h2 class="mb-3"><a href="sermons">Know Jesus Christ Better Through Lines</a></h2>
	          		<div class="meta">
		  						<p>
