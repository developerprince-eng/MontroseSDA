    ...
    <section class="ftco-section contact-section">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-4">
            <p><span>Address:</span> 116 Hebert Chitepo Street
Bulawayo, Zimbabwe</p>
          </div>
          <div class="col-md-4">
            <p><span>Phone:</span> <a href="tel://1234567920">+263 77 251 5101</a></p>
          </div>
          <div class="col-md-4">
            <p><span>Email:</span> <a href="mailto:info@byocitycentrechurch.org.zw">info@byocitycentrechurch.org.zw</a></p>
          </div>
        </div>
