    ...
    <div id="wrapper">
        ...
        <div id="content" class="no-padding">
            <div class="jumbotron jumbotron-fluid" style="background: white;">
                <div class="container">
                    <h1 class="display-4" style="text-align: center;">Coming Soon</h1>
                    <p class="lead" style="text-align: center">Currently the Developer is Working on this Section, please come back later</p>
                </div>
            </div>
        </div>
        <!-- footer begin -->
