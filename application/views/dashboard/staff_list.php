            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php echo form_open('dashboard/home_delete_item'.$item['sid']) ?>
                            <input type="submit" value="delete" class="btn btn-danger btn-block">
                        </form>
                        <br>
                        <?php echo form_open('/dashboard/home_approve_item/'. $item['sid'])?>
                        ...
                        <br>
                        <?php echo form_open('/dashboard/home_suspend_item/'. $item['sid'])?>
